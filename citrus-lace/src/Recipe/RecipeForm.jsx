...
export default function RecipeForm({ postRecipe }) {
  ...
  const checkRecipeValidity = () => {
    if (!recipe.recipe_title || !recipe.yield_amount || !recipe.yield_type) {
      setValid(false);
    } else {
      setValid(true);
    }
  ...
  return (
    <div className='ui form'>
      <span>
        <img
          className='add-recipe-logo'
          src='https://res.cloudinary.com/dhqnbwexr/image/upload/v1643311982/android-chrome-192x192_rpqt8p.png'
          alt='citrus lace logo'
        />
      ...
      <form className='ui form'>
        <input
          ...
          onChange={(e) => updateRecipe(e, 'recipe_title')}
          required='required'
          autoFocus={true}
        />
        <span className='yield-input'>
          <input
            ...
            onChange={(e) => updateRecipe(e, 'yield_amount')}
            required='required'
          />
          <input
            type='text'
            ...
            onChange={(e) => updateRecipe(e, 'yield_type')}
            required='required'
          />
          <div className='system-container'>
            ...
            <input
              ...
              onClick={(e) => updateRecipe(e, 'Metric')}
            />
            ...
            <input
              ...
              onClick={(e) => updateRecipe(e, 'Imperial')}
            />
          </div>
        </span>
        <IngredientField
        ...
        />
        <textarea
          onChange={(e) => updateRecipe(e, 'method')}
          placeholder='Method'
        ></textarea>
        <button onClick={(e) => saveRecipe(e)}>
          {saved ? 'Saved!' : 'SaveRecipe'}
        </button>
      </form>
      <IngredientFieldList
        ingredients={ingredients}
